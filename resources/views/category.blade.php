...
<div class="card col-sm-8 mx-auto">
	<div class="card-header">
		...
		<a style="color:white" class="btn btn-success float-right" data-toggle="modal" data-target="#modalAddCategory">New Category</a>               
	</div>
  <!-- /.card-header -->
  <div class="card-body">
  	 <div class="box-body">
...
<div id="modalAddCategory" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form role="form" action="{{ url('/add-category') }}" method="post" enctype="multipart/form-data">
      	@csrf
        <!--=====================================
            MODAL HEADER
        ======================================-->  
            ...
            <div class="box-body">
              ...
              <div class="form-group">          
                <div class="input-group">             
                  ...
                  <input type="text" class="form-control input-lg" name="category_name" placeholder="Category Name" required>
                </div>
              </div>
          <!--=====================================
            MODAL FOOTER
